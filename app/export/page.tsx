...
export default function ExportPage() {
    ...
    // Redirect if no segments or assets
    React.useEffect(() => {
                ...
                <Card>
                    {videoUrl ? (
                        <div className="text-center py-8">
                            ...
                            <p className="text-gray-400 mb-6">你的影片已準備就緒</p>

                            <div className="flex flex-col gap-4 max-w-xs mx-auto">
                                <a
                                    href={videoUrl}
                                    download
                                    className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white font-medium rounded-lg transition-all"
                                >
                        ...
                        <div className="text-center py-8">
                            ...
                            <p className="text-gray-400 mb-6">{exportError}</p>
                        ...
                        <div className="text-center py-8">
                            ...
                            <h3 className="text-xl font-semibold text-white mb-2">正在匯出影片...</h3>
                            <p className="text-gray-400">這可能需要一些時間，請稍候</p>
                        </div>
                    ) : (
                        <div className="text-center py-8">
                            ...
                            <p className="text-gray-400 mb-6">點擊下方按鈕開始生成最終影片</p>
